...
pub trait IntoElement:
    IntoNode + IntoChildNode + IntoParentNode + internal::IntoElementInner
{
    ...
    fn owner_document(&self) -> Option<&crate::DocumentRef> {
        IntoNode::owner_document(self)
    }
    fn owner_document_mut(&mut self) -> Option<&mut crate::DocumentRef> {
...
pub(crate) mod internal {
    use crate::{DOMTokenList, DocumentRef, NamedNodeMap, ShadowRootRef, Tag};
