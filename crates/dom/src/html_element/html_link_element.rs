...
impl AsHTMLElement for HTMLLinkElement {
...
impl AsElement for HTMLLinkElement {
...
impl InnerHtml for HTMLLinkElement {
...
impl AsParentNode for HTMLLinkElement {}
impl AsChildNode for HTMLLinkElement {}
impl AsNode for HTMLLinkElement {
...
impl<T: AsNode> PartialEq<T> for HTMLLinkElement {
    fn eq(&self, other: &T) -> bool {
        AsNode::cast(self) == other
    }
}
impl AsEventTarget for HTMLLinkElement {
...
impl TryFrom<HTMLElement> for HTMLLinkElement {
